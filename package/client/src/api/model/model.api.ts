...
export const postQualityPhreecParamAPI = async (
  params: QualityPhreecParamBodyType,
) => {
  const url = `/api/v1/model/param/quality-phreec`
  const response: DataFetchAPIInterface<ModelParamType> = await extendFetch(
    url,
    {
      method: 'post',
...
export const postQualityPhreec3DParamAPI = async (
  params: QualityPhreec3DParamBodyType,
) => {
  const url = `/api/v1/model/param/quality-phreec-3d`
  const response: DataFetchAPIInterface<ModelParamType> = await extendFetch(
    url,
    {
      method: 'post',
