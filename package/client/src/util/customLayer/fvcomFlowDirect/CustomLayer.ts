...
class CustomLayer implements mapboxgl.CustomLayerInterface{
     ...
     */
    constructor(id: string, renderingMode: "2d" | "3d" | undefined) {
        this.id = id;
     ...
     */
    onAdd(_map: mapboxgl.Map, _gl: WebGL2RenderingContext): void {
     ...
     */
    prerender?(_gl: WebGL2RenderingContext, _u_matrix: Array<number>): void {
     ...
     * @param u_matrix mapbox camera view projection matrix
     */
    render(_gl: WebGL2RenderingContext, _u_matrix: Array<number>): void {
        // console.log("custom layer on render");
        // console.log('current context', gl);
        // console.log('current matrix', u_matrix);
    }

    onRemove(_map: mapboxgl.Map, _gl: WebGL2RenderingContext): void {
...
function changeRenderingContext(): void {
    ...
    //     const _setupPainter_old = (mapboxgl.Map.prototype as any)._setupPainter;
...
function GetMap(accessToken: string, mapOption: any, needChangeContext = true): Map {
